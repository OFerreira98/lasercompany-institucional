...
window.LaserData = {
  ...
  */
  lasers: [
    { nome: 'Vydence Alex One', tipo: 'Depilação a Laser', img: 'assets/img/maquinas/vydence-alex-one.png', beneficios: ['Todos os fototipos', 'Alexandrite + ND-YAG', 'Resfriamento contínuo'] },
    { nome: 'Quanta Q Plus', tipo: 'Laser Q-Switched', img: 'assets/img/maquinas/quanta-q-plus.png', beneficios: ['Remoção de tatuagem', 'Melasma e manchas', 'Rejuvenescimento'] },
    { nome: 'Ultracel Q+', tipo: 'Ultrassom Microfocado', img: 'assets/img/maquinas/ultracel-q-plus.png', beneficios: ['Lifting sem cortes', 'Papada e fox eyes', 'Estimula colágeno'] },
  ],
